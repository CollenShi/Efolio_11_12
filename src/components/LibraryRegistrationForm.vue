    ...
    <div class = "container mt-5">
        <div class = "row">
            <div class = "col-md-8 offset-md-2">
                <h1 class = "text-center">W5. Libaray Registration Form</h1>
                <span style="display: block; text-align: center;">Let's build some more advanced features into our form</span>
                <form @submit.prevent = "submitForm">
                    ...
                    <div class="text-center">
                        ...
                        <button type="button" class="btn btn-secondary" @click="clearFormAndCards">Clear</button>
                    </div>
                </form>
            </div>
        </div>
...
const validateReason = (blur) => {
    ...
    console.log(reason.indexOf('friend'));
    if (reason.length < minLength) {
        ...
        if (blur) errors.value.reason = `Reason must be at most ${maxLength} characters`;
        success.value.reason = null;
    } else if (reason.indexOf('friend') >= 0) {
...
const validateGender = (blur) => {
    ...
    if (!gender || gender.length<=0) {
        if (blur) errors.value.gender = `Gender must choose`;
    } else {
        errors.value.reason = null
    }
}
